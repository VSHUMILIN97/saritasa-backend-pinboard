# Generated by Django 2.1 on 2018-08-21 08:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='backend/assets/image_ad', verbose_name='Photo')),
                ('address', models.CharField(max_length=100, verbose_name='Address')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Date of creation')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='Date of modification')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='RUB', max_digits=14, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advertisement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advertisement.Advertisement', verbose_name='Advertisement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=300, verbose_name='Text')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Date of creation')),
                ('applier', models.CharField(blank=True, max_length=150, verbose_name='Applier')),
                ('confirmed', models.BooleanField(blank=True, null=True, verbose_name='Is confirmed')),
                ('advertisement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advertisement.Advertisement', verbose_name='Advertisement')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
